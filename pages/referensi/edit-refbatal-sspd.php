...
if (isset($_GET['edit']) || isset($_POST['edit'])) {
  ...
  $updq = "update KETBATAL SET KD_BATAL='$KD_BATAL', KET_BATAL='$KET_BATAL' WHERE KD_BATAL='$ID'";
  if (mysqli_query($conn, $updq)) {
    $_SESSION['notif'] = "Data Berhasil Diubah";
    header("Location: refbatal-sspd.php");
  } else {
    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Ref Ket. Batal SSPD</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Persiapan &gt; Ref Ket. Batal SSPD &gt; Edit Ref Ket. Batal SSPD
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                  ...
                                  $se = "select * from KETBATAL where KD_BATAL = '".$kd."'";
                                  ...
                                  while ($data = mysqli_fetch_assoc($sec)) { ?>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="refbatal-sspd.php" class="btn btn-default">Batal</a>
                                        </td>
                                      </tr>
                                    </table>
                                  </div>
