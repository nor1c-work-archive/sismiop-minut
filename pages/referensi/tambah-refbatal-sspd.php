...
if (isset($_GET['insert']) || isset($_POST['insert'])) {
  ...
  $updq = "INSERT INTO KETBATAL SET KD_BATAL='$KD_BATAL', KET_BATAL='$KET_BATAL'";
    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Referensi Ket. Batal SSPD</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Persiapan &gt; Ref Ket. Batal SSPD &gt; Tambah Referensi Ket. Batal SSPD
                        </div>
                        <!-- /.panel-heading -->
