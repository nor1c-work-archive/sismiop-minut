                            ...
                            <div class="table-responsive">
                              <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                    <table class="table table-bordered">
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM KELAS_TANAH_2016 where KD_KLS_TANAH='".$_GET['refid']."'";
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" name="KD_KLS_TANAH" value="<?=$data['KD_KLS_TANAH']?>" size="50" style="padding:5px;border-radius:4px;border:solid 1px #ccc;">
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" name="THN_AWAL_KLS_TANAH" value="<?=$data['THN_AWAL_KLS_TANAH']?>" size="50" style="padding:5px;border-radius:4px;border:solid 1px #ccc;">
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" name="THN_AKHIR_KLS_TANAH" value="<?=$data['THN_AKHIR_KLS_TANAH']?>" size="50" style="padding:5px;border-radius:4px;border:solid 1px #ccc;">
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" name="NILAI_MIN_TANAH" value="<?=$data['NILAI_MIN_TANAH']?>" size="50" style="padding:5px;border-radius:4px;border:solid 1px #ccc;">
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" name="NILAI_MAX_TANAH" value="<?=$data['NILAI_MAX_TANAH']?>" size="50" style="padding:5px;border-radius:4px;border:solid 1px #ccc;">
                                          </td>
                                        </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" name="NILAI_PER_M2_TANAH" value="<?=$data['NILAI_PER_M2_TANAH']?>" size="50" style="padding:5px;border-radius:4px;border:solid 1px #ccc;">
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
