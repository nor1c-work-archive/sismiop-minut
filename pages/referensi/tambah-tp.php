...
if (isset($_GET['insert']) || isset($_POST['insert'])) {
  ...
  $updq = "INSERT INTO TEMPAT_PEMBAYARAN SET KD_KANWIL='$KD_KANWIL',
                                    KD_KPPBB='$KD_KPPBB',
  ...
  if (mysqli_query($conn, $updq)) {
    $_SESSION['notif'] = "Tempat Pembayaran Berhasil Ditambah";
    header("Location: tempatpembayaran.php");
  } else {
    $_SESSION['gagal'] = "Tempat Pembayaran Gagal Ditambah";
    header("Location: tempatpembayaran.php");
  }
}
            ...
            <div class="row">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Referensi &gt; Tempat Pembayaran &gt; Tambah Tempat Pembayaran
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="table-responsive">
                                <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="KD_KANWIL" value="" class="form-control" placeholder="Kode Kanwil">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="KD_KPPBB" value="" class="form-control" placeholder="Kode KPPBB">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="KD_BANK_TUNGGAL" value="" class="form-control" placeholder="Kode Bank Tunggal">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="KD_BANK_PERSEPSI" value="" class="form-control" placeholder="Kode Bank Persepsi">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="KD_TP" value="" class="form-control" placeholder="Kode Tempat Pembayaran">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="NM_TP" value="" class="form-control" placeholder="Nama Tempat Pembayaran">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="ALAMAT_TP" value="" class="form-control" placeholder="Alamat Tempat Pembayaran">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <input type="text" name="NO_REK_TP" value="" class="form-control" placeholder="Nomor Rekening Tempat Pembayaran">
                                    </td>
                                  </tr>
