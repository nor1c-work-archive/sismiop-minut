...
if (isset($_GET['edit']) || isset($_POST['edit'])) {
  $ID = $_POST['id'];
  $KD_BATAL = $_POST['KD_BATAL'];
  $KET_BATAL = $_POST['KET_BATAL'];

  $updq = "update KETBATAL_SPPT SET KD_BATAL='$KD_BATAL', KET_BATAL='$KET_BATAL' WHERE KD_BATAL='$ID'";
  if (mysqli_query($conn, $updq)) {
    $_SESSION['notif'] = "Data Berhasil Diubah";
    header("Location: refbatal-sppt.php");
  } else {
    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Ref Ket. Batal SPPT</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Persiapan &gt; Ref Ket. Batal SPPT &gt; Edit Ref Ket. Batal SPPT
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                  ...
                                  $se = "select * from KETBATAL_SPPT where KD_BATAL = '".$kd."'";
                                  ...
                                  while ($data = mysqli_fetch_assoc($sec)) { ?>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="KD_BATAL" value="<?=$data['KD_BATAL']?>" style="width:40%;" class="form-control" readonly="true">
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="KET_BATAL" value="<?=$data['KET_BATAL']?>" size="40" class="form-control">
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="refbatal-sppt.php" class="btn btn-default">Batal</a>
                                        </td>
                                      </tr>
                                    </table>
                                  </div>
