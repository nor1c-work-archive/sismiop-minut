    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ref Ket. Batal SSPD</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Persiapan &gt; Ref Ket. Batal SSPD
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                      <?php
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="edit-refbatal-sspd.php?refid=<?=$data['KD_BATAL']?>">Edit</a>
                                            |
                                            <a onclick="return confirm('Are you sure ?')" href="delete-refbatal-sspd.php?refid=<?=$data['KD_BATAL']?>">Delete</a>
                                          </td>
                                        </tr>
                                        <?php }
                                      ?>
                                ...
                                <a class="btn btn-primary" href="tambah-refbatal-sspd.php">Tambah Referensi Ket. Batal SSPD</a>
                            </div>
                          </div>
                            <!-- /.table-responsive -->
                        </div>
