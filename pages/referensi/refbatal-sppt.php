    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ref Ket. Batal SPPT</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Persiapan &gt; Ref Ket. Batal SPPT
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM KETBATAL_SPPT";
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="edit-refbatal-sppt.php?refid=<?=$data['KD_BATAL']?>">Edit</a>
                                            |
                                            <a onclick="return confirm('Are you sure ?')" href="delete-refbatal-sppt.php?refid=<?=$data['KD_BATAL']?>">Delete</a>
                                          </td>
                                        </tr>
                                        <?php }
                                      ?>
                                ...
                                <a class="btn btn-primary" href="tambah-refbatal-sppt.php">Tambah Referensi Ket. Batal SPPT</a>
                            </div>
                          </div>
                            <!-- /.table-responsive -->
                        </div>
