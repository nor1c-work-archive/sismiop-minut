...
if ($_SESSION['ROLE']=="ADMINISTRATOR") {
  ...
  if (isset($_POST['simpan'])) {
    ...
    $insert = "INSERT INTO PEKERJAAN_KEGIATAN SET KD_PEKERJAAN='$KD_PEKERJAAN', KD_KEGIATAN='$KD_KEGIATAN', NM_KEGIATAN='$NM_KEGIATAN'";
    if (mysqli_query($conn, $insert) or die (mysqli_error($conn))) {
      $_SESSION['notif'] = "Data Pekerjaan Kegiatan Berhasil Disimpan";
      header("Location: ref-pekerjaankegiatan.php");
    } else {
      $_SESSION['gagal'] = "Data Pekerjaan Kegiatan Gagal Disimpan";
      header("Location: ref-pekerjaankegiatan.php");
    }
  }
                              ...
                              <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" placeholder="Nama Kegiatan" name="NM_KEGIATAN" value="" size="50" class="form-control" required>
                                          </td>
                                        </tr>
