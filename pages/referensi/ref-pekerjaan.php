            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Referensi &gt; Referensi Pekerjaan
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                      <?php
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <center>
                                              <a class="btn btn-success btn-sm" href="edit-ref-pekerjaan.php?refid=<?=$data['KD_PEKERJAAN']?>">Edit</a>
                                              <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure ?')" href="delete-ref-pekerjaan.php?refid=<?=$data['KD_PEKERJAAN']?>">Delete</a>
                                            </center>
                                          </td>
                                        </tr>
                                        <?php }
                                ...
                                <a class="btn btn-primary btn-sm" href="tambah-ref-pekerjaan.php">Tambah Referensi Pekerjaan</a>
                            </div>
                          </div>
                            <!-- /.table-responsive -->
                        </div>
