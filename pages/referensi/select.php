            ...
            <!-- /.row -->
                <div class="col-lg-12 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <!-- <a href="../wilayah/select.php">
                            <div class="panel-footer">
                                <span class="pull-left">Wilayah</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        <a href="../kepegawaian/select.php">
                            <div class="panel-footer">
                                <span class="pull-left">Kepegawaian</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a> -->
                        <a href="tempatpembayaran.php">
                            <div class="panel-footer">
                                <span class="pull-left">Tempat Pembayaran</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        <a href="refkelurahan.php">
                            <div class="panel-footer">
                                <span class="pull-left">Manajemen Pengguna</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        <a href="select-ketbatal.php">
                            <div class="panel-footer">
                                <span class="pull-left">Keterangan Batal</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        <a href="select-klstanahbng.php">
                            <div class="panel-footer">
                                <span class="pull-left">Kelas Tanah/Bangunan</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
...
<!--                         <a href="refbatal-sspd.php">
                        ...
                        <a href="refbatal-sppt.php">
                            <div class="panel-footer">
                                <span class="pull-left">Harga Resource</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a> -->
