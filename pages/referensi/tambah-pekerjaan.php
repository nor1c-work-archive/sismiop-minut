...
if ($_SESSION['ROLE']=="ADMINISTRATOR") {
  ...
  if (isset($_POST['simpan'])) {
    ...
    $insert = "INSERT INTO REF_PEKERJAAN_WP SET KD_PEKERJAAN='$KD_PEKERJAAN', PEKERJAAN='$PEKERJAAN'";
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Referensi &gt; Referensi Pekerjaan WP &gt; Tambah Referensi Pekerjaan WP
                        </div>
                        <!-- /.panel-heading -->
                              ...
                              <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                          ...
                                          <td style="width:50%;">
                                            <input type="text" placeholder="Pekerjaan" name="PEKERJAAN" value="" size="50" class="form-control" required>
                                          </td>
                                        </tr>
