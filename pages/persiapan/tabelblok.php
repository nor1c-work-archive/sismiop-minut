    ...
    <div id="wrapper">
      <?php include("../header2.php") ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pembuatan Tabel Blok</h1>
                </div>
            </div>
            <div class="row">
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Persiapan &gt; Pembuatan Tabel Blok
                        </div>
                        <?php 
                                ...
                                <tr>
                                    <td style="width:45%;padding-right:5px;">
                                        ...
                                        while ($sqlr = mysqli_fetch_assoc($sqlq)) { ?>
                                            <option selected hidden disabled readonly value="<?=$sqlr['KD_KECAMATAN']?>"><?=$sqlr['KD_KECAMATAN']?> - <?=$sqlr['NM_KECAMATAN']?></option>
                                        <?php } ?>
                                    ...
                                    <td style="width:45%;padding-right:5px;">
                                        <select id="kelurahan" name="kelurahan" class="form-control">
                                            ...
                                            while ($data = mysqli_fetch_assoc($sqlq)) { ?>
                                                <option selected hidden disabled readonly><?=$KD_KELURAHAN?> - <?=$data['NM_KELURAHAN']?></option>
                                            <?php } ?>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM DAT_PETA_BLOK where KD_KECAMATAN='".$KD_KECAMATAN."' and KD_KELURAHAN='".$KD_KELURAHAN."'";
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM DAT_PETA_BLOK";
                                        $userc = mysqli_query($conn, $user);
                                        while ($data = mysqli_fetch_assoc($userc)) {
                                        ?>
                                        <tr>
