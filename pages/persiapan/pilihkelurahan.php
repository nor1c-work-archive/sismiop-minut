    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ref Kelurahan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home &gt; Ref Kelurahan &gt; Ref Kelurahan
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM REF_KELURAHAN WHERE KD_KECAMATAN='".$KD_KECAMATAN."'";
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <form class="" action="previewkelurahan.php" method="post">
