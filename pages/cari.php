...
<!-- BATAS MENU -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home &gt; Monitoring &gt; Pencarian Data
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                ...
                                <input type="text" name="KD_PROPINSI" required>
                                <input type="text" name="KD_DATI2" required>
                                <input type="text" name="KD_KECAMATAN" required>
                                <input type="text" name="KD_KELURAHAN" required>
                                <input type="text" name="KD_BLOK" required>
                                <input type="text" name="NO_URUT" required>
                                <input type="text" name="KD_JNS_OP" required>
    ...
    <tbody>
        <tr>
            ...
            <td><?=$row['NM_WP']?></td>
            <td>
            <form target="_blank" method="post" action="pembatalan.php?NOP=<?=$row['KD_PROPINSI'].$row['KD_DATI2'].$row['KD_KECAMATAN'].$row['KD_KELURAHAN'].$row['KD_BLOK'].$row['NO_URUT'].$row['KD_JNS_OP']?>">
