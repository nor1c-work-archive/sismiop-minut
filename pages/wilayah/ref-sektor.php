    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Referensi Jenis Sektor</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Referensi &gt; Wilayah &gt; Jenis Sektor
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <?php } ?>
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" >
                                    ...
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM REF_JNS_SEKTOR";
                                        ...
                                        <tr>
                                          ...
                                          <td><?=$data['NM_SEKTOR']?></td>
                                          <td>
                                            <center>
                                            <a class="btn btn-success" href="edit-sektor.php?refid=<?=$data['KD_SEKTOR'].'.'.$data['NM_SEKTOR']?>">Edit</a>
                                            <a class="btn btn-danger" onclick="return confirm('Are you sure ?')" href="delete-sektor.php?deleteref=<?=$data['KD_SEKTOR'].'.'.$data['NM_SEKTOR']?>">Hapus</a>
                                            </center>
                                          </td>
                                        </tr>
                                        <?php }
                                ...
                                <a class="btn btn-primary" href="tambah-sektor.php">Tambah Referensi Jenis Sektor</a>
                            </div>
                          </div>
                            <!-- /.table-responsive -->
                        </div>
