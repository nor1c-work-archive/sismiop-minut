...
if (isset($_GET['insert']) || isset($_POST['insert'])) {
  ...
  $updq = "INSERT INTO REF_DATI2 SET KD_PROPINSI='$KD_PROPINSI', KD_DATI2='$KD_DATI2', NM_DATI2='$NM_DATI2'";
  if (mysqli_query($conn, $updq)) {
    $_SESSION['notif'] = "Kota/Kabupaten Berhasil Disimpan";
    header("Location: ref-dati2.php");
  } else {
    $_SESSION['gagal'] = "Kota/Kabupaten Gagal Disimpan";
    header("Location: ref-dati2.php");
  }
}
    ...
    <div id="wrapper">
      ...
      <?php include("../header2.php"); ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Kota/Kabupaten</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Persiapan &gt; Wilayah &gt; Kota/Kabupaten &gt; Tambah Kota/Kabupaten
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="table-responsive">
                                <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <input type="text" name="KD_DATI2" placeholder="Kode Dati II" value="" class="form-control">
                                      </td>
                                    </tr>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <input type="text" name="NM_DATI2" placeholder="Nama Dati II" value="" class="form-control">
                                      </td>
                                    </tr>
