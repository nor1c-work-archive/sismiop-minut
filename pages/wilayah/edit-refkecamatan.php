...
if (isset($_GET['edit']) || isset($_POST['edit'])) {
  ...
  $updq = "update REF_KECAMATAN SET KD_PROPINSI='$KD_PROPINSI', KD_DATI2='$KD_DATI2', KD_KECAMATAN='$KD_KECAMATAN', NM_KECAMATAN='$NM_KECAMATAN' WHERE KD_KECAMATAN='$ID'";
    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Referensi Kecamatan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Referensi &gt; Referensi Kecamatan &gt; Edit Referensi Kecamatan
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                  ...
                                  $se = "select * from REF_KECAMATAN where KD_KECAMATAN = '".$kd."'";
                                  ...
                                  while ($data = mysqli_fetch_assoc($sec)) { ?>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input class="form-control" type="text" name="KD_PROPINSI" value="<?=$data['KD_PROPINSI']?>" size="40" readonly>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input class="form-control" type="text" name="KD_DATI2" value="<?=$data['KD_DATI2']?>" size="40" readonly>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input class="form-control" type="text" name="KD_KECAMATAN" value="<?=$data['KD_KECAMATAN']?>" size="40" readonly>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input class="form-control" type="text" name="NM_KECAMATAN" value="<?=$data['NM_KECAMATAN']?>" size="40">
                                        </td>
                                      </tr>
