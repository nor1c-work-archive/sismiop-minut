    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Referensi Kecamatan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM REF_KECAMATAN";
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="edit-refkecamatan.php?refid=<?=$data['KD_KECAMATAN']?>">Edit</a>
                                            |
                                            <a onclick="return confirm('Are you sure ?')" href="delete-refkecamatan.php?refid=<?=$data['KD_KECAMATAN']?>">Delete</a>
                                          </td>
                                        </tr>
                                        <?php }
                                      ?>
                                ...
                                <a class="btn btn-primary" href="tambah-refkecamatan.php">Tambah Referensi Kecamatan</a>
                            </div>
                          </div>
                            <!-- /.table-responsive -->
                        </div>
