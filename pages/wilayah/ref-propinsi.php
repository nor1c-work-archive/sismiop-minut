    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Referensi Provinsi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Referensi &gt; Wilayah &gt; Referensi Provinsi
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <?php } ?>
                                    ...
                                    <tbody>
                                      <?php
                                        ...
                                        <tr>
                                          ...
                                          <td><?=$data['NM_PROPINSI']?></td>
                                          <td>
                                            <center>
                                            <a class="btn btn-success" href="edit-propinsi.php?refid=<?=$data['KD_PROPINSI'].'.'.$data['NM_PROPINSI']?>">Edit</a>
                                            <a class="btn btn-danger" onclick="return confirm('Are you sure ?')" href="delete-propinsi.php?deleteref=<?=$data['KD_PROPINSI'].'.'.$data['NM_PROPINSI']?>">Hapus</a>
                                            </center>
                                          </td>
                                        </tr>
                                        <?php }
                                ...
                                <a class="btn btn-primary" href="tambah-propinsi.php">Tambah Referensi Propinsi</a>
                            </div>
                          </div>
                            <!-- /.table-responsive -->
                        </div>
