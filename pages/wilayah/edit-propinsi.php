...
if (isset($_GET['edit']) || isset($_POST['edit'])) {
  ...
  $updq = "update REF_PROPINSI SET NM_PROPINSI='$NM_PROPINSI' WHERE KD_PROPINSI='$KD_PROPINSI'";
  if (mysqli_query($conn, $updq)) {
    $_SESSION['notif'] = "Propinsi Berhasil Diupdate";
    header("Location: ref-propinsi.php");
  } else {
    $_SESSION['gagal'] = "Propinsi Gagal Diupdate";
    header("Location: ref-propinsi.php");
  }
}
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                  list($KD_PROPINSI, $NM_PROPINSI) = explode(".", $_GET['refid']);

                                  $se = "select * from REF_PROPINSI where KD_PROPINSI = '".$KD_PROPINSI."' and NM_PROPINSI='".$NM_PROPINSI."'";
                                  ...
                                  while ($data = mysqli_fetch_assoc($sec)) { ?>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <input type="text" name="NM_PROPINSI" value="<?=$data['NM_PROPINSI']?>" size="40" class="form-control">
                                        </td>
                                      </tr>
