            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Referensi &gt; Kepegawaian &gt; Jabatan
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <?php } ?>
                                    ...
                                    <tbody>
                                      <?php
                                        ...
                                        <tr>
                                          ...
                                          <td><?=$data['SINGKATAN_JABATAN']?></td>
                                          <td>
                                            <center>
                                            <a class="btn btn-success" href="edit-jabatan.php?refid=<?=$data['KD_JABATAN'].'.'.$data['NM_JABATAN'].'.'.$data['SINGKATAN_JABATAN']?>">Edit</a>
                                            <a class="btn btn-danger" onclick="return confirm('Are you sure ?')" href="delete-jabatan.php?deleteref=<?=$data['KD_JABATAN'].'.'.$data['NM_JABATAN'].'.'.$data['SINGKATAN_JABATAN']?>">Hapus</a>
                                            </center>
                                          </td>
                                        </tr>
                                        <?php }
                                ...
                                <a class="btn btn-primary" href="tambah-jabatan.php">Tambah Jabatan</a>
                            </div>
                          </div>
                            <!-- /.table-responsive -->
                        </div>
