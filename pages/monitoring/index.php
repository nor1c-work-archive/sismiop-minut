...
<!-- BATAS MENU -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home &gt; Monitoring &gt; Pencarian Obyek Pajak
                        </div>
                        <!-- /.panel-heading -->
    ...
    <tbody>
        <tr>
            ...
            <td><?=$row['NM_WP']?></td>
            <td>
            <form target="_blank" method="post" action="detail.php?NOP=<?=$row['KD_PROPINSI'].$row['KD_DATI2'].$row['KD_KECAMATAN'].$row['KD_KELURAHAN'].$row['KD_BLOK'].$row['NO_URUT'].$row['KD_JNS_OP']?>">
