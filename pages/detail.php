...
$qDetailSPPT="
select JLN_WP_SPPT, a.THN_PAJAK_SPPT, NM_WP_SPPT, JLN_WP_SPPT, LUAS_BUMI_SPPT, LUAS_BNG_SPPT,
PBB_YG_HARUS_DIBAYAR_SPPT, TGL_JATUH_TEMPO_SPPT, JML_SPPT_YG_DIBAYAR, TGL_PEMBAYARAN_SPPT
    ...
    <div id="wrapper">
       ...
       <!-- </nav> -->
        <div id="">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Detail SPPT</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
