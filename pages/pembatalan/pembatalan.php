      ...
      <!-- Navigation -->
       ...
       <!-- </nav> -->
        ...
        <div id="">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pembatalan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Monitoring &gt; Pembatalan STTS
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                          ...
                          <div class="dataTable_wrapper">
                              <table width="104%" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td><input type="checkbox" name="select_bayar[]" value="<?=$datSPPTLunas['THN_PAJAK_SPPT']?>"></td>
                              ...
                              <div style="float:right">
                                ...
                                <input type="submit" name="batal" value="Batalkan" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
                              </div>
                              </form>
