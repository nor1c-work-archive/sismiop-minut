    ...
    <div id="wrapper">
      ...
      <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Print SSPD 3 Rangkap</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home &gt; Export & Print Menu &gt; Print SSPD 3 Rangkap
                        </div>
                        <!-- /.panel-heading -->
                                      ...
                                      <?php
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <form class="" action="run-printsspd3r.php" method="post">
                                              <input type="hidden" name="KD_KECAMATAN" value="<?=$data['KD_KECAMATAN']?>">
                                              <input type="hidden" name="KD_KELURAHAN" value="<?=$data['KD_KELURAHAN']?>">
                                              <input onclick="return confirm('Anda Yakin?')" class="btn btn-primary" type="submit" name="print" value="Print">
                                            </form>
                                          </td>
                                        </tr>
                                        <?php }
