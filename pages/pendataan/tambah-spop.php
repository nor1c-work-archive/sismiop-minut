...
<!-- BATAS MENU -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Form SPOP</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-home"></i> Home &gt; Pendataan Objek Pajak &gt; SPOP &gt; Tambah SPOP
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="panel-body">
                              <table>
                                <tr>
                                  ...
                                  <td style="padding-top:10px;">
                                    <input type="text" required value="SPOP" readonly disabled class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td style="padding-top:10px;">
                                    <input type="text" required id="THN_FORMULIR" name="THN_FORMULIR" class="form-control" style="width:15%;display:inline-block" value="<?=date('Y',time())?>" maxLength="4">
                                    <input type="text" required id="INPUT_FORMULIR_2" name="INPUT_FORMULIR_2" class="form-control" style="width:15%;display:inline-block" value="<?=date('md', time())?>">
                                    <?php $rr = "select NO_FORMULIR as DIGIT from SPOP ORDER BY NO_FORMULIR DESC LIMIT 1";
                                    $rrr = mysqli_query($conn, $rr) or die(mysqli_error($conn));
                                    $rrrr = mysqli_fetch_assoc($rrr);
                                    if ($rrrr['DIGIT']=='') {
                                      $dynamicstring = "001";
                                    } else if (substr($rrrr['DIGIT'], -3) == '999') {
                                      $dynamicstring = "001";
                                    }
                                    else {
                                      $dynamicstring = substr($rrrr['DIGIT']+1, -3);
                                    }
                                    ?>
                                    <input type="text" required id="INPUT_FORMULIR_3" value="<?=$dynamicstring;?>" name="INPUT_FORMULIR_3" class="form-control" style="width:15%;display:inline-block">
                                    <a href="#" id="checkbtnformulir" class="btn btn-success">Cek Ketersediaan Formulir</a>
                                    <span id="checkformulir"></span>
                                  </td>
                                </tr>
                              </table>
                              <br>
                              <table>
                                <tr>
                                  ...
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" required id="KD_KECAMATAN" name="KD_KECAMATAN" value="<?=$KD_KECAMATAN?>" class="form-control" readonly>
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" required id="KD_KELURAHAN" name="KD_KELURAHAN" value="<?=$KD_KELURAHAN?>" class="form-control" readonly>
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" required id="KD_BLOK" name="KD_BLOK" value="<?=$KD_BLOK?>" class="form-control" readonly>
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" required id="NO_URUT" name="NO_URUT" maxlength="4" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" required id="KD_JNS_OP" name="KD_JNS_OP" maxlength="1" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <a href="#" id="checkbtn" class="btn btn-success">Cek</a>
                                  </td>
                                  <td>
                                    <span id="check"></span>
                                  </td>
                              ...
                              <table>
                                <tr>
                                  ...
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_PROPINSI_BERSAMA" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_DATI2_BERSAMA" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_KECAMATAN_BERSAMA" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_KELURAHAN_BERSAMA" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_BLOK_BERSAMA" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="NO_URUT_BERSAMA" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_JNS_OP_BERSAMA" class="form-control">
                                  </td>
                                </tr>
                              </table>
                              <br>
                              <table>
                                <tr>
                                  ...
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_PROPINSI_ASAL" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_DATI2_ASAL" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_KECAMATAN_ASAL" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_KELURAHAN_ASAL" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_BLOK_ASAL" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="NO_URUT_ASAL" class="form-control">
                                  </td>
                                  <td width="80" style="padding-right:10px;">
                                    <input type="text" name="KD_JNS_OP_ASAL" class="form-control">
                                  </td>
                                </tr>
                              </table>
                            </div>
                            ...
                            <div class="panel-body">
                              <table style="float:left;">
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="KTP_WP" placeholder="Nomor KTP" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <select required class="form-control" name="STATUS_PEKERJAAN_WP">
                                      <option selected disabled readonly>PILIH PEKERJAAN</option>
                                      <?php
                                      $sql = "select * from REF_PEKERJAAN_WP";
                                      $sqla = mysqli_query($conn, $sql);
                                      while ($data = mysqli_fetch_assoc($sqla)) {
                                      ?>
                                        <option value="<?=$data['KD_PEKERJAAN']?>"><?=$data['KD_PEKERJAAN'].' - '.$data['PEKERJAAN']?></option>
                                      <?php } ?>
                                    </select>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="NPWP" placeholder="NPWP" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">Jalan</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="JALAN_WP" placeholder="Jalan WP" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">RT/RW</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required style="width:20%;display:inline-block;" name="RT_WP" placeholder="RT" class="form-control"> / 
                                    <input type="text" required style="width:20%;display:inline-block;" name="RW_WP" placeholder="RW" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">Dati II</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="KOTA_WP" placeholder="Dati II" class="form-control">
                                  </td>
                                </tr>
                              </table>
                              <table style="float:right">
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <select required class="form-control" name="KD_STATUS_WP">
                                      <option selected readonly disabled>PILIH STATUS WP</option>
                                      <?php
                                      $sql = "select * from REF_STATUS_WP";
                                      $sqla = mysqli_query($conn, $sql);
                                      while ($statwp = mysqli_fetch_assoc($sqla)) { ?>
                                        <option value="<?=$statwp['KD_STATUS']?>"><?=$statwp['KD_STATUS'] .' - '. $statwp['STATUS_WP']?></option>
                                      <?php } ?>
                                    </select>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="NM_WP" placeholder="Nama WP" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">Telp.</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="TELP_WP" placeholder="Telepon" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">Blok/Kav/No.</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="BLOK_KAV_NO_WP" placeholder="Blok/Kav/No." class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    ...
                                    <input type="text" required name="KELURAHAN_WP" value="<?=$data['NM_KELURAHAN']?>" placeholder="Kelurahan" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">Kode Pos</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="KD_POS_WP" placeholder="Kode Pos" class="form-control">
                                  </td>
                                </tr>
                              </table>
                            </div>
                            ...
                            <div class="panel-body">
                              <table style="float:left;">
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="NO_PERSIL" placeholder="No. Persil" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">Blok/Kav/No.</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="BLOK_KAV_NO_OP" placeholder="Blok/Kav/No." class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  <td style="padding-bottom:10px;" width="130">RT/RW</td>
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required style="width:20%;display:inline-block;" name="RT_OP" placeholder="RT" class="form-control"> / 
                                    <input type="text" required style="width:20%;display:inline-block;" name="RW_OP" placeholder="RW" class="form-control">
                                  </td>
                                </tr>
                              </table>
                              <table style="float:right">
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" placeholder="Jalan OP" width="300" style="padding-right:10px;">
                                    <select required class="form-control" name="JALAN_OP">
                                      <option selected readonly disabled>PILIH JALAN</option>
                                      <?php $sql = "select * from JALAN_STANDARD ORDER BY NM_JLN_SEMENTARA";
                                      $sqla = mysqli_query($conn, $sql);
                                      while($data = mysqli_fetch_assoc($sqla)) { ?>
                                        <option value="<?=$data['NM_JLN_SEMENTARA']?>"><?=$data['NM_JLN_SEMENTARA']?></option>
                                      <?php } ?>
                                    </select>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <label style="font-weight:100;"><input type="checkbox" name="KD_STATUS_CABANG" value="0"> Bukan</label>
                                  </td>
                                </tr>
                              </table>
                            </div>
                              ...
                              <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <select required class="form-control" name="KD_KLS_TANAH">
                                      <option selected readonly disabled>PILIH KODE KELAS TANAH</option>
                                      <?php $sql = "select * from KELAS_TANAH_2016";
                                      $sqla = mysqli_query($conn, $sql);
                                      while ($data = mysqli_fetch_assoc($sqla)) { ?>
                                        <option value="<?=$data['KD_KLS_TANAH']?>"><?=$data['KD_KLS_TANAH']?></option>
                                      <?php } ?>
                                    </select>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="TOTAL_LUAS_BUMI" placeholder="Luas Tanah" class="form-control">
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <select required class="form-control" name="KD_ZNT">
                                      <option selected readonly disabled>PILIH KODE ZNT</option>
                                      <?php $sql = "select * from DAT_PETA_ZNT where KD_KECAMATAN='".$KD_KECAMATAN."' and KD_KELURAHAN='".$KD_KELURAHAN."' and KD_BLOK='".$KD_BLOK."'";
                                      $sqla = mysqli_query($conn, $sql);
                                      while ($data = mysqli_fetch_assoc($sqla)) { ?>
                                        <option value="<?=$data['KD_ZNT']?>"><?=$data['KD_ZNT']?></option>
                                      <?php } ?>
                                    </select>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <select required class="form-control" name="JNS_TANAH">
                                      <option selected readonly disabled>PILIH JENIS TANAH</option>
                            ...
                            <div class="panel-body">
                              ...
                              <table style="float:right">
                                <tr>
                                  ...
                                  <td style="padding-bottom:10px;" width="300" style="padding-right:10px;">
                                    <input type="text" required name="NIP_PENDATA" class="form-control" value="<?=$_SESSION['NIP']?>">
                                  </td>
                                </tr>
                                <!--<tr>
