    ...
    <div id="wrapper">
      ...
      <?php include("../header2.php") ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Jalan Standar</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Home &gt; Pendataan &gt; Update Jalan Standar
                        </div>
                        <!-- /.panel-heading -->
                        <?php 
                            ...
                            <?php } ?>
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th width="30">No</th>
                                            <th width="200">Nama Jalan Sementara</th>
                                            <th width="200">Nama Jalan Standar</th>
                                    ...
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM JALAN_STANDARD where KD_KECAMATAN='".$KD_KECAMATAN."' and KD_KELURAHAN='".$KD_KELURAHAN."'";
                                        $userc = mysqli_query($conn, $user);
                                        while ($data = mysqli_fetch_assoc($userc)) {
                                        ?>
                                        <tr>
                                          <td><?=$no++?></td>
                                          <td><?=$data['NM_JLN_SEMENTARA']?></td>
                                          <td><?=$data['NM_JLN_STANDARD']?></td>
                                          <td>
                                            ...
                                            <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                              ...
                                              <center>
                                                  <a href="editjalan.php?refedit=<?=$data['KD_KECAMATAN'].'.'.$data['KD_KELURAHAN'].'.'.$data['NM_JLN_SEMENTARA']?>" class="btn btn-success btn-sm">Edit</a>
                        ...
                        <?php } else if (isset($_POST['filter']) || isset($_GET['filter']) || isset($_POST['hapus']) || isset($_GET['hapus'])) { ?>
                            <div class="panel-body">
                        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                            <table>
                                <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <form class="" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                                              ...
                                              <input type="hidden" name="KD_KELURAHAN" value="<?=$data['KD_KELURAHAN']?>">
                                              <center>
                                                  <a href="editjalan.php?refedit=<?=$data['KD_KECAMATAN'].'.'.$data['KD_KELURAHAN'].'.'.$data['NM_JLN_SEMENTARA']?>" class="btn btn-success">Edit</a>
                                                  <!-- <input class="btn btn-danger" type="submit" name="hapus" value="Hapus"> -->
                                              </center>
                                            </form>
                                          </td>
                            ...
                            <?php } ?>
                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th width="40">No</th>
                                            <th>Nama Jalan Sementara</th>
                                            <th>Nama Jalan Standar</th>
                                            <th width="70">Modify</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <?php
                                        $no = 1;
                                        $user = "SELECT * FROM JALAN_STANDARD";
                                        $userc = mysqli_query($conn, $user);
                                        while ($data = mysqli_fetch_assoc($userc)) {
                                        ?>
                                        <tr>
