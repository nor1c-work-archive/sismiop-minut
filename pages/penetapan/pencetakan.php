...
<!-- BATAS MENU -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pencetakan Massal</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="glyphicon glyphicon-home"></i> Home &gt; Penetapan &gt; Pencetakan Massal
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <form action="proses.php" method="post" target="_blank">
                              <table>
                                ...
                                <tr>
                                    ...
                                    <br>
                                    <label style="font-weight:100"><input type="radio" name="select" value="sppt"> SPPT</label>
                                    <br>
                                    <label style="font-weight:100"><input type="radio" name="select" value="dhkp"> DHKP</label>
                                    </td>
                                </tr>
                            </table>
                          </div>
                          ...
                          <table style="float:right;">
                            <tr>
                              <td>
                                <input type="submit" target="_blank" name="proses" value="Export" class="btn btn-primary" >
